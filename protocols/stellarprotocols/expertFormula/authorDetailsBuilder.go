...
func (expertFormula ExpertFormula) BuildPublicManageData(publicKeyHash string) (txnbuild.ManageData, error) {
	...
	if !configs.PGPkeyEnable && len(publicKeyHash) > 64 {
		logrus.Error("Expert public key is less than 64 character limit, It is a stellar public key")
		return txnbuild.ManageData{}, errors.New("Expert public key is less than 64 character limit, It is a stellar public key")
	}
