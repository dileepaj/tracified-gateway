...
contract WaterUse {
	...
	//Metadata structure
	struct Metadata {
		string formulaID; //initialize at start
	...
	Metadata metadata = Metadata("631a0b4ad9241a9374f9f001EthTes101","Water use","GBOK5LA4FABVOK76XOZGYHXDF5XYMS5FQJ7XZNP6TTAG6NYS766TO7EF");
	...
	ReferredConstant WATER_TO_ELECTRICITY_UNIT = ReferredConstant(Value("REFERREDCONSTANT", "faa0754b7eddd458180b1d36ff9c0494", "water to e. unit", 200, 0, ""), "kWh", "Reference URL");
	...
	// value initialization for SEMANTICCONSTANT -> ELECTRICITY_UNIT_TO_CARBON_EMISSION01
	SemanticConstant ELECTRICITY_UNIT_TO_CARBON_EMISSION01 = SemanticConstant(Value("SEMANTICCONSTANT", "faa0754b7eddd458180b1d36ff4c0492", "e. unit to carb. em.", 15, 0, ""));
