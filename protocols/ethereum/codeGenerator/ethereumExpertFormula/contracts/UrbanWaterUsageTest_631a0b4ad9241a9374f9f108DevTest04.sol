...
contract UrbanWaterUsageTest_631a0b4ad9241a9374f9f108DevTest04 {
	...
	Metadata metadata = Metadata("631a0b4ad9241a9374f9f108DevTest04","Urban water usage test","0x78459834yruhfcuryty40493850745");
	...
	function executeCalculation() public {
		result.value = calculations.Multiply(WATER.value.value, WATER.value.exponent, calculations.Add(WATER_TO_ELECTRICITY_UNIT.value.value, WATER_TO_ELECTRICITY_UNIT.value.exponent, ELECTRICITY_UNIT_TO_CARBON_EMISSION.value.value, ELECTRICITY_UNIT_TO_CARBON_EMISSION.value.exponent), calculations.GetExponent());
